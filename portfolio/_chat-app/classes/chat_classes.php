<?php
   ...
   class Chat {
      function __construct() {
         ...
         if(isset($_SESSION["logged_in"]) && isset($_POST["msg"]) && trim($_POST["msg"]) !== ''){
         ...
         if(isset($_SESSION["logged_in"]) && isset($_GET["refreshMessages"])){
      ...
      public function StoreMessage($msg){
         ...
         if($connect) {
            $sql = "INSERT INTO messages (`message`, `uid`, `uname`) VALUES (?, ?, ?)";
